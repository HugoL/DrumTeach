CREATE TABLE `dt_users` (
  ...
  `lastvisit_at_at` int(10) NOT NULL DEFAULT '0',
...
INSERT INTO `dt_users` (`id`, `username`, `password`, `email`, `activkey`, `createtime`, `lastvisit_at_at`, `superuser`, `status`) VALUES
...
CREATE TABLE `dt_profiles_fields` (
